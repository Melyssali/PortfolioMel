...
import nextjs from '../../src/assets/nextjs-icon.svg';
...
import git from '../../src/assets/github-icon.svg';
...
const defaultStyles = {
  getContainer: (radius: number, fullWidth: boolean, fullHeight: boolean) =>
    ({
      position: 'relative',
      width: fullWidth ? '100%' : `${3 * radius}px`,
      maxWidth: '100%',
      minHeight: `${2 * radius}px`,
      height: fullHeight ? '100%' : `${3 * radius}px`,
      touchAction: 'none',
    } as CSSProperties),
};
